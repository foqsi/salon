<template>
  <div class="bg-gray-100 min-h-screen flex flex-col items-center py-20">
    <header class="container mx-auto text-center mb-12">
      ...
      <p class="text-gray-600 mt-4">We’d love to hear from you! Fill out the form below or visit us at our location.</p>
    </header>
        ...
        <div>
          <form @submit.prevent="handleSubmit" class="bg-white p-8 rounded-lg shadow-md">
            ...
            <div class="mb-4">
              ...
              <input type="tel" id="phone" v-model="form.phone" class="w-full p-2 border border-gray-300 rounded"/>
            </div>
            ...
            <button type="submit" class="bg-pink-600 text-white px-6 py-2 rounded-full text-lg hover:bg-pink-700">Send Message</button>
          </form>
        </div>
