<template>
  <div class="bg-gray-100 max-w-5xl mx-auto leading-relaxed">
    <main class="container mx-auto px-4">
      <section class="mb-12 flex flex-col md:flex-row items-start">
        <!-- Text Content -->
        <div class="md:w-1/2">
        ...
        <!-- Image -->
        <div class="md:w-1/2 md:pl-8 mt-4 sm:mt-20 mb-20 sm:mb-4">
          <img
